 ...
 * Justification for clarification of this work: Why standard for federated learning APIs are actually required? Does it enough that each federated learning framework has its own specific API, not a standard API?
